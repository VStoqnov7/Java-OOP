package P15Exams.P17Exam.onlineShop.models.products;
...
public abstract class BaseProduct implements Product {
    ...
    public String toString() {
        return String.format(OutputMessages.PRODUCT_TO_STRING,this.overallPerformance,this.price,this.getClass().getSimpleName(),this.manufacturer,this.model,this.id);
    }
}
